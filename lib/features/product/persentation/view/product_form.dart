...
import 'package:elysia/features/product/application/application.dart';
...
final priceControllerProv = StateProvider.autoDispose<TextEditingController>(
    (ref) => TextEditingController());
...
final isProductErrorProvider = StateProvider.autoDispose<bool>(
  (ref) => false,
);
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            ErrorCondition(isProductError: isProductError, size: size),
            SizedBox(
              width: size.width,
